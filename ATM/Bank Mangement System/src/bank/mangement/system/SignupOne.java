...
import com.toedter.calendar.JDateChooser; // For date chooser
import java.awt.event.*; // For ActionListener

public class SignupOne extends JFrame implements ActionListener {
    long random;
    JTextField nameTextField, fnameTextField, emailTextField, cityTextField, stateTextField, pincodeTextField, addressTextField;
    JButton next;
    ...
    SignupOne() {
        ...
        random = Math.abs((ran.nextLong() % 9000L) + 1000L); // Generate random application number
